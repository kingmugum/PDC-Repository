# -*- coding: utf-8 -*-
"""
Oracle Checker rev85 - Optional CAPL Event Collector helper.
...
def generate_capl_text(catalog: CollectorCatalog) -> str:
    ...
    lines.extend([
        "/*@!Encoding:65001*/",
        "/*",
        "  Oracle Checker rev85 - OPTIONAL CAPL Event Collector",
        ...
        "  If this node is absent/old/uncompiled, Python falls back to rev85 COM polling + ASC/BLF review.",
        "*/",
        "",
        "variables",
        "{",
