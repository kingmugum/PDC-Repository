...
from environment_manager import check_environment, format_status, install_or_repair
from ext_file_manager import ExtFileError, list_ext_files
from folder_resolver import FolderResolutionError, app_root, runtime_root, resolve_target_folder
...
class BoardRepoApp(tk.Tk):
    ...
    def _install_environment_worker(self):
        try:
            status = install_or_repair(self.log)
    ...
    def _build_target_plan(self, key: str) -> list[UploadPlanItem]:
        ...
        folder = resolve_target_folder(DATA_ROOT, target["folder_aliases"])
